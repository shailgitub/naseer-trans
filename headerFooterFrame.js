  ...
  />
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          <a href="index3.html" class="nav-item nav-link active">Home</a>
          <a href="index3.html#about" class="nav-item nav-link">About</a>
          <div class="nav-item dropdown">
            <a
              href="index3.html#services"
         ...
         <!-- <div class="nav-item dropdown">
          ...
          <a href="index3.html#pricing" class="nav-item nav-link">Pricing</a>
